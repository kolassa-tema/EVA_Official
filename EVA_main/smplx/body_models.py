...
TensorRotMatOutput = namedtuple('TensorRotMatOutput',
                          ['vertices', 'joints', 'betas', 'expression', 'v_shaped', 'full_pose', 'A', 'T', 'f'])
...
class SMPLX_Rot_mat(SMPLH):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SMPLX_Rot_mat, self).__init__(
            model_path=model_path,
            kid_template_path=kid_template_path,
            data_struct=data_struct,
            dtype=dtype,
    ...
    def forward(
        ...
        **kwargs
        ...
        output = TensorRotMatOutput(vertices=vertices if return_verts else None,
                              joints=joints,
                              betas=betas,
                              expression=expression,
                              v_shaped=v_shaped,
