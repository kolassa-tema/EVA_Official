...
class Camera(nn.Module):
    def __init__(self, colmap_id, pose_id, R, T, K, FoVx, FoVy, image, gt_alpha_mask,
                 ...
                 face_mask=None, lhand_mask=None, rhand_mask=None,
                 face_render_mask=None, lhand_render_mask=None, rhand_render_mask=None,
                 depth=None, kp2d=None,
        ...
        self.lhand_mask = lhand_mask
        self.rhand_mask = rhand_mask
        self.face_render_mask = face_render_mask
        self.lhand_render_mask = lhand_render_mask
        self.rhand_render_mask = rhand_render_mask
        self.depth = depth
        self.kp2d = kp2d
